...
```{r respcomplaint, dev = "tikz", fig.cap = "The difference in median response time by complaint type.", fig.height = 7, sanitize = TRUE}
...
mod <- vglm(n ~ agency, data = calls_2017_agg, family = "posnegbinomial")
